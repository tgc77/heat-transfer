...
/*
#define I_ 6       // nº de nós da malha
#define N_ 10      // nº de intervalos de tempo(deltaT), em segundos, para discretizar os I nós na barra
#define L_ 10
#define K 0.49
#define C 0.2174
#define Rho 2.7
